document.addEventListener('DOMContentLoaded', () => {
    ...
    let posicoesPadrao = {
        posicaoYInicialDente: 8,
        margemXEntreDentes: 8,
        margemYEntreDentes: 10
    }
    ...
    let dimensoesTrapezio = {
        ...
        lateral: tamanhoDente / 2,
        baseMenor: (tamanhoDente / 2) * 1
    }
    ...
    const resizeCanvas = () => {
        ...
        valoresBase = {
            x: (camada1.width * 2) / tamanhoTelaReferencia,
            y: (camada1.width * 2) / tamanhoTelaReferencia,
            largura: (camada1.width * 7) / tamanhoTelaReferencia,
            altura: (camada1.width * 15) / tamanhoTelaReferencia
        }
