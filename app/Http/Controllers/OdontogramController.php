...
class OdontogramController extends Controller
{
    ...
    function index($id){
        ...
        $data =DB::select("SELECT * FROM odontogram_pasien JOIN master_simbol_odontogram WHERE odontogram_pasien.kondisi = master_simbol_odontogram.id AND odontogram_pasien.id_pasien = $id ORDER BY odontogram_pasien.id ASC");
