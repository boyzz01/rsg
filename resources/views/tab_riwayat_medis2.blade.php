    ...
    <form action="{{ route('rm.update',1) }}" method="post" name="form1" autocomplete="off">
        ...
        <div class="form-group row">
            ...
            <label class="col-2 col-form-label">Golongan
                Darah</label>
            <div class="col-5">
                <select class="form-control" name="gol" id="gol" disabled>
            ...
            <div class="col-5">
                <select class="form-control" disabled name="res" id="tekanan" disabled>
                    <option value="" disabled selected>Pilih</option>
                    @php
                    $oklusi = array("+","-");
                    @endphp
        ...
        <div class="form-group row">
            ...
            <div class="col-3">
                <input class="form-control" disabled type="text" value="{{ $rm->td }}" placeholder=".../... mmHg"
                    name="td" id="example-text-input" />
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                <select class="form-control" disabled name="pj" id="gol">
                    <option value="" disabled selected>Pilih</option>
                    @php
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                <select class="form-control" disabled name="asma" id="gol">
                    <option value="" disabled selected>Pilih</option>
                    @php
                    $oklusi = array("Ada","Tidak Ada");
                    @endphp
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                <select class="form-control" disabled name="diabetes" id="gol">
                    <option value="" disabled selected>Pilih</option>
                    @php
                    $oklusi = array("Ada","Tidak Ada");
                    @endphp
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                <select class="form-control" disabled name="haemo" id="gol">
                    <option value="" disabled selected>Pilih</option>
                    @php
                    $oklusi = array("Ada","Tidak Ada");
                    @endphp
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                <select class="form-control" disabled name="hepa" id="gol">
                    <option value="" disabled selected>Pilih</option>
                    @php
                    $oklusi = array("Ada","Tidak Ada");
                    @endphp
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                <select class="form-control" disabled name="gas" id="gol">
                    <option value="" disabled selected>Pilih</option>
                    @php
                    $oklusi = array("Ada","Tidak Ada");
                    @endphp
        ...
        <div class="form-group row">
            ...
            <div class="col-10">
                <input class="form-control" disabled type="text" value="{{ $rm->pl }}" name="pl"
        ...
        <div class="form-group row">
            ...
            <div class="col-10">
                <input class="form-control" disabled type="text" value="{{ $rm->alergi_obat }}" name="alergi_obat"
                    id="example-text-input" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-10">
                <input class="form-control" disabled type="text" value="{{ $rm->alergi_makanan }}" name="alergi_makanan"
                    id="example-text-input" />
            </div>
        </div>
