<div class="card-body">
    <form action="{{ route('rm.update', 1) }}" method="post" name="form1" autocomplete="off">
        ...
        <div class="form-group row">
            ...
            <div class="col-3">
                <input class="form-control" type="text" value="{{ $rm->td }}" placeholder=".../... mmHg"
        ...
        <div class="form-group row">
            ...
            <div class="col-10">
                <input class="form-control" type="text" value="{{ $rm->pl }}" name="pl"
        ...
        <button type="Submit" name="Submit" class="btn btn-primary mt-4 mb-2 float-right">Update Riwayat Medis</button>
    </form>
