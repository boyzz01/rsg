<table style="overflow-x:auto;" width="100%">
    <tbody>
        <tr>
            <td>
                <div id="svgselect" style="width:800px;height:300px;">
                    <svg version="1.1" height="100%" width="100%">
                        <g transform="scale(1.7)" id="gmain">
                            <g id="18" transform="translate(0,0)">
                                <polygon data-ket="" points="5,5 	15,5 	15,15 	5,15" fill="white" stroke="navy"
                                    stroke-width="0.5" id="O" opacity="1"></polygon>
                                <polygon data-ket="" points="0,0 	20,0 	15,5 	5,5" fill="white" stroke="navy"
                                    stroke-width="0.5" id="B" opacity="1">
                                </polygon>
                                <polygon data-ket="" points="5,15 	15,15 	20,20 	0,20" fill="white" stroke="navy"
                                    stroke-width="0.5" id="P" opacity="1"></polygon>
                                <polygon data-ket="" points="15,5 	20,0 	20,20 	15,15" fill="white" stroke="navy"
                                    stroke-width="0.5" id="M" opacity="1"></polygon>
                                <polygon data-ket="" points="0,0 	5,5 	5,15 	0,20" fill="white" stroke="navy"
                                    stroke-width="0.5" id="D" opacity="1">
                                </polygon>
                            ...
                            <g id="13" transform="translate(125,0)">
                                <polygon data-ket="" points="5,5 	15,5 	15,15 	5,15" fill="white" stroke="navy"
                                    stroke-width="0.5" id="I" opacity="1"></polygon>
                                <polygon data-ket="" points="0,0 	20,0 	15,5 	5,5" fill="white" stroke="navy"
                                    stroke-width="0.5" id="L" opacity="1">
                                </polygon>
                                <polygon data-ket="" points="5,15 	15,15 	20,20 	0,20" fill="white" stroke="navy"
                                    stroke-width="0.5" id="P" opacity="1"></polygon>
                                <polygon data-ket="" points="15,5 	20,0 	20,20 	15,15" fill="white" stroke="navy"
                            ...
                            <g id="85" transform="translate(75,80)">
                                <polygon data-ket="" points="5,5 	15,5 	15,15 	5,15" fill="white" stroke="navy"
                                    stroke-width="0.5" id="C" opacity="1"></polygon>
                                <polygon data-ket="" points="0,0 	20,0 	15,5 	5,5" fill="white" stroke="navy"
                                    stroke-width="0.5" id="T" opacity="1">
                                </polygon>
                                <polygon data-ket="" points="5,15 	15,15 	20,20 	0,20" fill="white" stroke="navy"
                                    stroke-width="0.5" id="B" opacity="1"></polygon>
                                <polygon data-ket="" points="15,5 	20,0 	20,20 	15,15" fill="white" stroke="navy"
                                    stroke-width="0.5" id="R" opacity="1"></polygon>
                                <polygon data-ket="" points="0,0 	5,5 	5,15 	0,20" fill="white" stroke="navy"
                                    stroke-width="0.5" id="L" opacity="1">
                                </polygon>
                                <text x="6" y="30" stroke="navy" fill="navy" stroke-width="0.1"
                ...
                </div><br><span>Gigi <span id="kposisi"></span> :</span><br><span id="kondisi-gigi" style="font-size: 20px;
                color: red;
                font-weight: 400;">--</span>
            </td>
            <td style="width:20%;padding-left:10px">
                <span class="gigi" style="font-size: 24px; color: black;font-weight: 400;">Posisi Gigi :</span>
                <br><span id="nomorgigi" style="font-size: 32px;
color: navy;
font-weight: 700;">XX</span><span class="gigi" style="font-size: 24px;
color: black;
font-weight: 400;">-</span><span id="posisigigi" style="font-size: 32px;
color: navy;
font-weight: 700;">X</span><br>
            </td>
        </tr>
    </tbody>
</table>