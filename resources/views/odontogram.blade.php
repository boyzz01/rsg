                    ...
                    <svg version="1.1" height="100%" width="100%">
                        <g transform="scale(1.7)" id="gmain">
                            <g id="18" transform="translate(0,0)">
                                <polygon data-ket="" points="5,5 	15,5 	15,15 	5,15" fill="white" stroke="navy" stroke-width="0.5"
                                    id="C" opacity="1"></polygon>
                                <polygon data-ket="" points="0,0 	20,0 	15,5 	5,5" fill="white" stroke="navy" stroke-width="0.5"
                                    id="T" opacity="1">
                                </polygon>
                                <polygon data-ket="" points="5,15 	15,15 	20,20 	0,20" fill="white" stroke="navy" stroke-width="0.5"
                                    id="B" opacity="1"></polygon>
                                <polygon data-ket="" points="15,5 	20,0 	20,20 	15,15" fill="white" stroke="navy" stroke-width="0.5"
                                    id="R" opacity="1"></polygon>
                                <polygon data-ket="" points="0,0 	5,5 	5,15 	0,20" fill="white" stroke="navy" stroke-width="0.5"
                                    id="L" opacity="1">
                                </polygon>
