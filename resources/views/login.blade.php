...
<head>
	...
	<meta charset="utf-8" />
	<title>Edental Clinic | Login</title>
			...
			<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat"
				...
				<div class="login-form text-center p-7 position-relative overflow-hidden">
					...
					<div class="d-flex flex-center mb-15" style="margin-bottom: 0rem !important;">
						<a href="#">
							<img src="assets/img/logo2.png" class="max-h-105px" alt="" />
						</a>
					</div>
					<!--end::Login Header-->
					...
					<div class="login-signin">
						<div class="mb-20">
							<h3>E dental Clinic</h3>
							<div class="text-muted font-weight-bold">Your Comprehensive Dental Care</div>
						</div>
